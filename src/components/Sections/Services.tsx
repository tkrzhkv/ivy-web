    ...
    <section className="w-screen min-h-screen">
      <div className="flex flex-col sm:flex-row w-full">
        ...
        <div className="w-full sm:w-[30%] p-6 sm:p-12 flex flex-col justify-between bg-black">
          <div>
            <div className="gap-4 sm:gap-8 text-[#D6C3B3]">
        ...
        <div className="w-full sm:w-[70%] flex flex-col md:flex-row">
          {services.map((service, index) => (
            ...
            >
              {/* Изображение */}
              <div className="relative w-full aspect-[2/3] sm:h-1/2">
                <Image
                  src={service.img}
                  alt={service.title}
                  fill
              ...
              {/* Текст */}
              <div className="flex flex-col justify-center items-center w-full border border-black bg-white p-4 sm:h-1/2">
                <h2 className="text-sm sm:text-xl md:text-xl font-cursive font-bold mb-3 text-black text-center">
                  {service.title}
                </h2>
                <p className="mb-2 text-[10px] sm:text-xs font-ivy_normal_bold text-[#4a0e0e] text-center">
                  {service.price}
                </p>
